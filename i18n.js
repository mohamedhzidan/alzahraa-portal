...
(function (global) {
  ...
  var DICT = {
    ar: {
      ...
      'login.demoTitle': 'حسابات الموظفين (اضغط للدخول السريع)',
      'login.demoHint': 'اضغط أي حساب لتعبئة بياناته — كل حساب له كلمة مرور خاصة',
    ...
    en: {
      ...
      'login.demoTitle': 'Staff accounts (click for quick sign-in)',
      'login.demoHint': 'Click an account to fill it in — each has its own password',
